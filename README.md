...
> *"Data enthusiast building interactive dashboards and learning tools with Python and Streamlit."*
...
A data-driven dashboard that scrapes product listings from eBay and displays actionable insights through clean visualizations.

**Key features:**
- ✅ Real-time product data scraping from eBay
